...
(function (globalObject, createModule) {
    ...
    xingParser.readXingTag = function (view, offset) {
        ...
        var xingOffset = offset + lib.getXingOffset(tag.header.mpegAudioVersionBits, tag.header.channelModeBits)
        ...
        tag._section.byteLength = lib.getFrameByteLength(tag.header.bitrate,
            tag.header.samplingRate, tag.header.framePadding, tag.header.mpegAudioVersionBits, tag.header.layerDescriptionBits);
