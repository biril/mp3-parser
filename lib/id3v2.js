...
(function (globalObject, createModule) {
    ...
    var id3v2TagFrameNames = {
        ...
        readFrameContentApic = function (buffer, offset, length) {
            ...
            offsetTrm = lib.locateStrTrm.iso(buffer, offsetBeg, length - 1);
            if (offsetTrm === -1) {
                return content; // Not found!
            }

            // Read MIME type
            content.mimeType = lib.readStr.iso(buffer, offsetBeg, offsetTrm - offsetBeg);
            ...
            content.pictureData = new DataView(buffer.buffer, offsetBeg, offset + length - offsetBeg);
