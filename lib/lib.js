...
(function (globalObject, createModule) {
    ...
    */
    ...
    lib.locateStrTrm = function (buffer, offset, length) {
    ...
    lib.locateStrTrmUcs2 = function (buffer, offset, length) {
    ...
    lib.readStr = function (buffer, offset, length) {
    ...
    lib.readTrmStr = function (buffer, offset, length) {
        var trmOffset = lib.locateStrTrm(buffer, offset, length);
        if (trmOffset !== -1) { length = trmOffset - offset; }
        return lib.readStr(buffer, offset, length);
    };
    ...
    lib.readStrUcs2 = function (buffer, offset, length) {
